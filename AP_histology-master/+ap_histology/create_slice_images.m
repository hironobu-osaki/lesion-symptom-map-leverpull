...
histology_toolbar_guidata.image_path_dir = dir(fullfile(histology_toolbar_guidata.image_path,'*.png'));
% (error if none found)
...
if ~im_is_rgb
    ...
    for curr_im = 1:n_im
        ...
        im_resized{curr_im,curr_channel}=imresize(imread(im_fn{curr_im}),1/downsample_factor);
        end
