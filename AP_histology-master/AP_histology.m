...
uimenu(gui_data.menu.annotation,'Text','Lesion','MenuSelectedFcn', ...
    {@ap_histology.annotate_lesion,histology_toolbar_gui});
...
% Pick image path
if ispc
    gui_data.image_path = uigetdir([],'Select path to save processing');
elseif ismac
